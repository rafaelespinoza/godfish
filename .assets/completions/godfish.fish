...
function __godfish_perform_completion
    ...
    for line in $results
        if not string match -q -- "godfish*" $line
...
# Clear existing completions for godfish
complete -c godfish -e
# Register completion function
complete -c godfish -f -a '(__godfish_perform_completion)'
